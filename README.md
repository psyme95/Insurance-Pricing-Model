...
| Metric | Poisson × Gamma GLM | XGBoost Tweedie |
|---|---|---|
| Normalised Gini | — | — |
| Double lift (top decile ratio) | — | — |
| Mean predicted vs actual PP | — | — |

**Double lift chart:**

*[Figure: predicted pure premium decile vs actual loss ratio — GLM vs XGBoost]*

**SHAP summary (XGBoost):**

*[Figure: global feature importance and example waterfall plot for high-risk vs low-risk policy]*
...
- **Catastrophe / large loss handling**: Severity models in practice often cap or separately model large losses (e.g. above the 99th percentile) to avoid distortion. Not implemented here.
